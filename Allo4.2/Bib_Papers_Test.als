...
pred IsolatedComponent 
{ let valves= V2VM+V3VM |
all s:TRCH+St+HP| some (IsolatedComponentApres[s] & valves) &&  some( IsolatedComponentAvant[s] & valves)}


fun IsolatedComponentApres[s: Component] : Component{
{ comp: V2VM+V3VM| some cl:Cl | comp in  s.ComponentConnected   || ((cl in s.ComponentConnected) && (comp in cl.ComponentConnected))}
}

fun IsolatedComponentAvant[s: Component] : Component{
{ comp: V2VM+V3VM| some cl:Cl | s in comp.ComponentConnected   || ((s in cl.ComponentConnected) && (cl in comp.ComponentConnected))}
}
